          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：人事管理-员工管理</td>
              </tr>
            </table></td>
      ...
      <tr>
        ...
        <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
            ...
            <td width="3%" class="mainIframeTableTh">工号</td>
            <td width="10%" class="mainIframeTableTh">姓名</td>
            <td width="10%" class="mainIframeTableTh">性别</td>
            <td width="10%" class="mainIframeTableTh">所在部门</td>
            <td width="10%" class="mainIframeTableTh">任职岗位</td>
            <td width="10%" class="mainIframeTableTh">职称</td>
            <td width="10%" class="mainIframeTableTh">当前状态</td>
            <td width="10%" class="mainIframeTableTh">备注</td>
            <td width="20%" class="mainIframeTableTh">基本操作</td>
          </tr>
 <s:iterator  value="employees" >  
          <tr>
            ...
            <td class="mainIframeTableTd"><span class="STYLE4">
             <a href="user_add?empId=${empId}&empName=${empName}">
            <img src="images/edt.gif" width="16" height="16" border="0"/>分配系统账户</a>&nbsp; &nbsp;

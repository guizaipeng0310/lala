...
<body>
 <form action="dept_add" method="post" name="frm">
            ...
            <td width="54%"><table border="0" align="right" cellpadding="0" cellspacing="0">
              <tr>
                <td width="60"><table width="90%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="STYLE1"><div align="center"><a onClick="javascript:document.getElementById('frm').action='dept_add?addAction=1';document.getElementById('frm').submit();"><img src="images/22.gif" width="14" height="14" border="0"/></a></div></td>
                    <td class="STYLE1"><div align="center">保存</div></td>
                  </tr>
                </table></td>
                <td width="80"><table width="90%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="STYLE1"><div align="center"><a onClick="javascript:document.getElementById('frm').action='dept_add?addAction=2';document.getElementById('frm').submit();return false;"><img src="images/22.gif" width="14" height="14" border="0"/></a></div></td>
        	...
        	<div style="height:440px;background-color:">
        		<div class="addDiv">
        			<table class="addTable">
        				...
        				<tr><td class="addTd">上级部门</td><td><s:select 
															       name="deptId"
															       list="#session['depts']"
															       listKey="deptId"
															       listValue="deptName"

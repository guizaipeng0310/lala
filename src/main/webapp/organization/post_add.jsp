...
<body>
 <form action="post_add" method="post" name="frm">
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：机构管理-新建岗位</td>
              </tr>
            </table></td>
            <td width="54%"><table border="0" align="right" cellpadding="0" cellspacing="0">
              <tr>
                <td width="60"><table width="90%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="STYLE1"><div align="center"><a onClick="javascript:document.getElementById('frm').action='post_add?addAction=1';document.getElementById('frm').submit();"><img src="images/22.gif" width="14" height="14" border="0"/></a></div></td>
                    <td class="STYLE1"><div align="center">保存</div></td>
                  </tr>
                </table></td>
                <td width="80"><table width="90%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="STYLE1"><div align="center"><a onClick="javascript:document.getElementById('frm').action='post_add?addAction=2';document.getElementById('frm').submit();return false;"><img src="images/22.gif" width="14" height="14" border="0"/></a></div></td>
        	...
        	<div style="height:440px;background-color:">
        		<div class="addDiv">
        			<table class="addTable">
        				<tr><td class="addTd">部门名称</td><td><input type="text" name="post.postName" value="${post.postName}" /></td></tr>
        				<tr><td class="addTd">上级岗位</td><td><s:select 
															       name="postId"
															       list="#session['posts']"
															       listKey="postId"
															       listValue="postName"

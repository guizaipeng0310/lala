				   ...
				   <input type="hidden" name="recruit.state" value="未提交" />
        			...
        			<table class="addTable">
        			 <tr>
        			    ...
        			    <td colspan="3"><input type="text" name="recruit.recruitTitle" style="width:612px"/></td>
        			 </tr>
        			 <tr>
        			 	<td class="addTd">申请人</td>
        			    <td><input type="text"  name="recruit.applyPerson" value="${employee.empName}" readonly="readonly"/></td>
        			    <td class="addTd2">申请部门</td>
        			    <td><input type="text" name="recruit.applyDept" value="${employee.dept.deptName}" readonly="readonly"/></td>
        			 </tr>
        			 <tr>
        			 ...
        			 <tr> 
        				...
        				<td colspan="3"><textarea name="recruit.applyReason" rows="5" cols="74"></textarea></td> 
        			 </tr>
        			 <tr> 
        			 ...
        			 <tr> 
        			    ...
        			    <td><input type="text" name="recruit.recruitPost" /></td>
						<td class="addTd2">招聘人数</td><td>
        				<input type="text" name="recruit.recruitCount" /></td>
        			 </tr>
        			 <tr>
        				<td class="addTd">工作年限</td>
        				<td><input type="text" name="recruit.workingAge" /></td>
        				<td class="addTd2">薪资待遇</td>
        				<td><input type="text" name="recruit.wage"/></td>
        				</tr>
        				<tr>
        				<td class="addTd">职位职责</td>
        				<td colspan="3"><textarea name="recruit.postRequire" rows="5" cols="74"></textarea></td>
        				</tr>
        				<tr> 
        				<td class="addTd">招聘人员要求</td>
        				<td colspan="3"><textarea name="recruit.personRequire" rows="5" cols="74"></textarea></td>
						</tr>
        			</table>
        		</div>

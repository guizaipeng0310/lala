          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：招聘管理-招聘管理</td>
              </tr>
            </table></td>
      ...
      <tr>
        ...
        <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
            ...
            <td width="8%" class="mainIframeTableTh">申请部门</td>
            <td width="4%" class="mainIframeTableTh">申请人</td>
            <td width="6%" class="mainIframeTableTh">申请日期</td>
            <td width="10%" class="mainIframeTableTh">招聘职位</td>
            <td width="5%" class="mainIframeTableTh">招聘人数</td>

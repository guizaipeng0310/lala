...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：招聘管理-我的招聘</td>
              </tr>
            </table></td>
 ...
 <s:iterator  value="recruits" >  
          <tr>
            ...
            <s:if test="%{state == '未提交'}">
           <a href="recruit_submit?recruitId=${recruitId}&currentPage=${page.currentPage}">
            <img src="images/send.gif" width="16" height="16" border="0"/>提交申请</a>&nbsp; &nbsp;
            <font color="#999999" >
            <img src="images/edt.gif" width="16" height="16" border="0"/>发布&nbsp; &nbsp;
            </font>
            <a href="recruit_update?recruitId=${recruitId}&currentPage=${page.currentPage}">
            ...
            <img src="images/send.gif" width="16" height="16" border="0"/>提交申请&nbsp; &nbsp;
	           <s:if test="%{approveResult == '同意'}">
	            <a href="recruit_publish?recruitId=${recruitId}&currentPage=${page.currentPage}">
	            <img src="images/edt.gif" width="16" height="16" border="0"/>发布</a>&nbsp; &nbsp;
	           </s:if>
	           <s:else>
	            <img src="images/edt.gif" width="16" height="16" border="0"/>发布&nbsp; &nbsp;
	           </s:else>
            ...
            <s:if test="%{state == '已发布' && approveResult == '同意'}">
            <a href="jobSeeker?recruitId=${recruitId}">查看</a>
            </s:if>
            <s:else>
            <font color="#999999" >查看</font>
            </s:else>
          ...
          <tr>
            ...
            <td><table border="0" align="right" cellpadding="0" cellspacing="0">
                ...
                <s:if test="page.hasFirst">
                  <td width="40">
                  	<a href="recruit?currentPage=1"><img src="images/first.gif" border=0></a>&nbsp;
                  </td>
                </s:if>
                <s:else>
                  <td width="40">
               ...
               <s:if test="page.hasPrevious">
                  <td width="40">
                  	<a href="recruit?currentPage=${page.currentPage-1}"><img src="images/back.gif" border=0></a>&nbsp;
                  </td>
                </s:if>
                <s:else>
                  <td width="40">
               ...
               <s:if test="page.hasNext">
                  <td width="40">
                  	<a href="recruit?currentPage=${page.currentPage+1}"><img src="images/next.gif" border=0></a>&nbsp;
                  </td>
                </s:if>
                <s:else>
                  <td width="40">
              ...
              <s:if test="page.hasLast">
                  <td width="40">
                  	<a href="recruit?currentPage=${page.totalPage}"><img src="images/last.gif" border=0></a>&nbsp;
                  </td>
                </s:if>
                <s:else>
                  <td width="40">

			...
			<script type="text/javascript">
				...
				function updateSubmit()
				{
					if (validate())
					{
						...
						frm.action = 'employeeRedeploy_update';
						frm.submit();
					}
				}
				function validate()
...
<body>
 <form action="employeeRedeploy_update" method="post" name="frm" onsubmit="return validate()">
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：人事管理-员工异动修改</td>
              </tr>
            </table></td>
            <td width="54%"><table border="0" align="right" cellpadding="0" cellspacing="0">
              <tr>
                <td width="60"><table width="90%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="STYLE1"><div align="center"><a onClick="updateSubmit();"><img src="images/22.gif" width="14" height="14" border="0"/></a></div></td>
        	...
        	<div style="height:440px;background-color:">
        		<div class="addDiv">
					...
					<table class="addTable">
        			    ...
        			    <td>
        			   <input type="text" name="employeeRedeploy.employee.empName" value="${employeeRedeploy.employee.empName}" readonly="readonly"/>
        			    </td>
        			    <td class="addTd2">员工工号</td><td>
        				<input type="text" name="employeeRedeploy.employee.empId" value="${employeeRedeploy.employee.empId}" readonly="readonly"/></td>
        			    </tr>
        				...
        				<td class="addTd2">申请时间</td><td><input type="text" name="employeeRedeploy.applyDate" value="${employeeRedeploy.applyDate}" class="Wdate" type="text" onfocus="WdatePicker({skin:'whyGreen'})" readonly="readonly"/></td> 
        				</tr>
        			</table>	
        		</div>
        		<br/><span style="width:20px"></span>
        		<input class="btnClick" name="add" type="submit" value="保存" onclick="frm.action='employeeRedeploy_update';" />
...
<script type="text/javascript">
	document.getElementById("employeeRedeploy.redeployTypeId").value = ${employeeRedeploy.redeployType.redeployTypeId};
	document.getElementById("employeeRedeploy.deptId").value = ${employeeRedeploy.dept.deptId};
	document.getElementById("employeeRedeploy.postId").value = ${employeeRedeploy.post.postId};
</script>

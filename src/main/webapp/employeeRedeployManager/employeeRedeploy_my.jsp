...
<body>
 <form action="employeeRedeploy_my" method="post" name="frm">
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：人事管理-我的异动</td>
              </tr>
            </table></td>
          ...
          <tr>
            ...
            <td><table border="0" align="right" cellpadding="0" cellspacing="0">
                ...
                <s:if test="page.hasFirst">
                  <td width="40">
                  	<a href="employeeRedeploy_my?currentPage=1"><img src="images/first.gif" border=0></a>&nbsp;
                  </td>
                </s:if>
                <s:else>
                  <td width="40">
               ...
               <s:if test="page.hasPrevious">
                  <td width="40">
                  	<a href="employeeRedeploy_my?currentPage=${page.currentPage-1}"><img src="images/back.gif" border=0></a>&nbsp;
                  </td>
                </s:if>
                <s:else>
                  <td width="40">
               ...
               <s:if test="page.hasNext">
                  <td width="40">
                  	<a href="employeeRedeploy_myemployeeRedeploy?currentPage=${page.currentPage+1}"><img src="images/next.gif" border=0></a>&nbsp;
                  </td>
                </s:if>
                <s:else>
                  <td width="40">
              ...
              <s:if test="page.hasLast">
                  <td width="40">
                  	<a href="employeeRedeploy_my?currentPage=${page.totalPage}"><img src="images/last.gif" border=0></a>&nbsp;
                  </td>
                </s:if>
                <s:else>
                  <td width="40">

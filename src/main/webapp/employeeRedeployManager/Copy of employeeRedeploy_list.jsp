...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：人事管理-员工异动</td>
              </tr>
            </table></td>
 ...
 <s:iterator  value="employeeRedeploys" >  
          <tr>
            ...
            <td class="mainIframeTableTd">${transactor}${state}</td>
            <td class="mainIframeTableTd"><span class="STYLE4">
            <a href="employeeRedeploy_send?redeployId=${redeployId}&currentPage=${page.currentPage}">
            <img src="images/send.gif" width="16" height="16" border="0"/>提交</a>&nbsp; &nbsp;
            <a href="employeeRedeploy_send?redeployId=${redeployId}&currentPage=${page.currentPage}">
            <img src="images/send.gif" width="16" height="16" border="0"/>报送</a>&nbsp; &nbsp;
            <a href="employeeRedeploy_transactor?redeployId=${redeployId}&currentPage=${page.currentPage}">

          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：人事管理-提交员工异动申请</td>
              </tr>
            </table></td>
            <td width="54%"><table border="0" align="right" cellpadding="0" cellspacing="0">
              <tr>
                <td width="60"><table width="90%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="STYLE1"><div align="center"><a href="#" onClick="javascript:if(validate()) document.getElementById('frm').submit();return false;"><img src="images/22.gif" width="14" height="14" border="0"/></a></div></td>
                    <td class="STYLE1"><div align="center">确认提交</div></td>
                  </tr>
                </table></td>
                <td width="60"><table width="90%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
...
for (var i = 0; i < selEmpId.length; i++)
{
	...
	{        
	    ...
	    break;        
        			    ...
        			    <img src="images/send.gif" width="16" height="16" border="0"/> 确认提交</a>&nbsp; &nbsp;
        			    </td>
        			    <td>
        			    <a href="employeeRedeploy"><img src="images/goback.gif" width="14" height="14" border="0"/> 取消</a>
        			    </td>
        			    </tr>
        			</table>
        		</div>

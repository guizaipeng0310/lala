...
<body>
 <form action="module" method="post" name="frm">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：系统管理-模块管理</td>
              </tr>
            </table></td>
            <td width="54%"><table border="0" align="right" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="60"><table width="90%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="STYLE1"><div align="center"><a href="module_add"><img src="images/22.gif" width="14" height="14" border="0"/></a></div></td>
                    <td class="STYLE1"><div align="center">新增</div></td>
                  </tr>
                </table></td>
                <td width="100"><table width="90%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="STYLE1"><div align="center"><a href="moduleTree" target="leftIframe"><img src="images/save.gif" width="14" height="14" border="0"/></a></div></td>
      ...
      <tr>
        ...
        <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
            ...
            <td width="10%" class="mainIframeTableTh">模块Id</td>
            <td width="15%" class="mainIframeTableTh">模块</td>
            <td width="10%" class="mainIframeTableTh">模块系列</td>
            <td width="15%" class="mainIframeTableTh">模块链接</td>
            <td width="10%" class="mainIframeTableTh">父模块Id</td>
            <td width="25%" class="mainIframeTableTh">模块功能</td>
 ...
 <s:iterator  value="modules" >  
          <tr>
            ...
            <td class="mainIframeTableTd">${moduleId}</td>
            <td class="mainIframeTableTd">${moduleName}</td>
            <td class="mainIframeTableTd">${moduleOrderNum}</td>
            <td class="mainIframeTableTd">${linkUrl}</td>
            <td class="mainIframeTableTd">${parentModuleId}</td>
            <td class="mainIframeTableTd">${moduleDescription}</td>
            <td class="mainIframeTableTd"><span class="STYLE4">
            <a href="module_update?moduleId=${moduleId}&currentPage=${page.currentPage}">
            <img src="images/edt.gif" width="16" height="16" border="0"/>编辑</a>&nbsp; &nbsp;
            <a onclick="return confirm('确定要删除吗？');" href="module_delete?moduleId=${moduleId}&currentPage=${page.currentPage}">
          ...
          <tr>
            ...
            <td><table border="0" align="right" cellpadding="0" cellspacing="0">
                ...
                <s:if test="page.hasFirst">
                  <td width="40">
                  	<a href="module?currentPage=1"><img src="images/first.gif" border=0></a>&nbsp;
                  </td>
                </s:if>
                <s:else>
                  <td width="40">
               ...
               <s:if test="page.hasPrevious">
                  <td width="40">
                  	<a href="module?currentPage=${page.currentPage-1}"><img src="images/back.gif" border=0></a>&nbsp;
                  </td>
                </s:if>
                <s:else>
                  <td width="40">
               ...
               <s:if test="page.hasNext">
                  <td width="40">
                  	<a href="module?currentPage=${page.currentPage+1}"><img src="images/next.gif" border=0></a>&nbsp;
                  </td>
                </s:if>
                <s:else>
                  <td width="40">
              ...
              <s:if test="page.hasLast">
                  <td width="40">
                  	<a href="module?currentPage=${page.totalPage}"><img src="images/last.gif" border=0></a>&nbsp;
                  </td>
                </s:if>
                <s:else>
                  <td width="40">

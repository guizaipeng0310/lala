...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <td width="54%"><table border="0" align="right" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="60"><table width="90%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="STYLE1"><div align="center" style="text-align: center;"><a href="javaScript:action('user_update','userId','${page.currentPage}')"><img src="images/33.gif" width="14" height="14" border="0"/></a></div></td>
                  	<td class="STYLE1"><div align="center">修改</div></td>
                  </tr>
                </table></td>
                <td width="52"><table width="88%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="STYLE1"><div align="center"><a href="javaScript:action('user_delete','userId','${page.currentPage}')"><img src="images/11.gif" width="14" height="14" border="0"/></a></div></td>
      ...
      <tr>
        ...
        <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
            ...
            <td width="15%" class="mainIframeTableTh">用户名</td>
            <td width="15%" class="mainIframeTableTh">员工</td>
            <td width="10%" class="mainIframeTableTh">工号</td>
            <td width="10%" class="mainIframeTableTh">角色</td>
            <td width="10%" class="mainIframeTableTh">用户模块</td>
            <td width="10%" class="mainIframeTableTh">权限</td>
 ...
 <s:iterator  value="users" >  
          <tr>
            ...
            <td class="mainIframeTableTd">${userId}</td>
            <td class="mainIframeTableTd">${userName}</td>
            <td class="mainIframeTableTd">${userTrueName}</td>
            <td class="mainIframeTableTd">${empId}</td>
            <td class="mainIframeTableTd"><s:iterator value="roles">${roleName}&nbsp;</s:iterator></td>
            <td class="mainIframeTableTd"><a href="userModule?userId=${userId}">分配</a></td>
            <td class="mainIframeTableTd"><a href="permission?userId=${userId}">查看</a></td>
            <td class="mainIframeTableTd"><span class="STYLE4">
            <a href="user_update?userId=${userId}&currentPage=${page.currentPage}">
            <img src="images/edt.gif" width="16" height="16" border="0"/>编辑</a>&nbsp; &nbsp;
            <a onclick="return confirm('确定要删除吗？');" href="user_delete?userId=${userId}&currentPage=${page.currentPage}">
          ...
          <tr>
            ...
            <td><table border="0" align="right" cellpadding="0" cellspacing="0">
                ...
                <s:if test="page.hasFirst">
                  <td width="40">
                  	<a href="user?currentPage=1"><img src="images/first.gif" border=0></a>&nbsp;
                  </td>
                </s:if>
                <s:else>
                  <td width="40">
               ...
               <s:if test="page.hasPrevious">
                  <td width="40">
                  	<a href="user?currentPage=${page.currentPage-1}"><img src="images/back.gif" border=0></a>&nbsp;
                  </td>
                </s:if>
                <s:else>
                  <td width="40">
               ...
               <s:if test="page.hasNext">
                  <td width="40">
                  	<a href="user?currentPage=${page.currentPage+1}"><img src="images/next.gif" border=0></a>&nbsp;
                  </td>
                </s:if>
                <s:else>
                  <td width="40">
              ...
              <s:if test="page.hasLast">
                  <td width="40">
                  	<a href="user?currentPage=${page.totalPage}"><img src="images/last.gif" border=0></a>&nbsp;
                  </td>
                </s:if>
                <s:else>
                  <td width="40">

...
<script type="text/javascript">
		function addModule(forwardAction) {
...
<body>
 <form action="module_add" method="post" name="frm">
            ...
            <td width="54%"><table border="0" align="right" cellpadding="0" cellspacing="0">
              <tr>
                <td width="60"><table width="90%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="STYLE1"><div align="center"><a href="" onclick="addModule('module_add');return false;"><img src="images/22.gif" width="14" height="14" border="0"/></a></div></td>
                ...
                <td width="60"><table width="90%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <a href="module"><img src="images/goback.gif" width="14" height="14" border="0" /></a></div></td>
      ...
      <tr>
        ...
        <td><s:actionmessage theme="simple"/>
        	<div style="height:440px;background-color:">
        		<div class="addDiv">
        			<table class="addTable">
        			 <tr>
        				...
        				<td colspan="3"><input type="text" name="module.moduleName" value="" style="width:250px" /></td>
        				</tr>
        				<tr> 
        		...
        		<input class="btnClick" onclick="addModule('module_add')" name="add" type="button" value="保存"/>
          		<input class="btnClick" name="cancel" type="button" value="保存继续" onclick="addModule('module_adds')" />
        	</div>
        </td>

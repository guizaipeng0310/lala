...
<body>
 <form action="leave_update" method="post" name="frm" onsubmit="return validate()">
        ...
        <td>
        	<div style="height:440px;background-color:">
        		<div class="addDiv">
				   ...
				   <input type="hidden" name="leave.leaveId" value="${leaveId}" />
				   <%
        			...
        			<table class="addTable">
        			 <tr>
        			    ...
        			    <td><input type="text" name="leave.applyDept" value="${leave.applyDept}" readonly="readonly"/></td>
        			 </tr>
        			 <tr>
        			 ...
        			 <tr>
        				...
        				<td><input type="text" name="leave.startTime" value="${leave.startTime}" class="Wdate" onClick="WdatePicker({startDate:'%y-%M-01 00:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true,skin:'whyGreen'})"/></td>
        				<td class="addTd2">结束时间</td>
        				<td><input type="text" name="leave.endTime" value="${leave.endTime}" class="Wdate" onClick="WdatePicker({startDate:'%y-%M-01 00:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true,skin:'whyGreen'})"/></td>
        			</tr>
        			 <tr> 
        				<td class="addTd">申请理由</td>
        				<td colspan="3"><textarea name="leave.applyReason" rows="6" cols="74">${leave.applyReason}</textarea></td> 
        			 </tr>
        			</table>
        		</div>
...
<script type="text/javascript">
document.getElementById("leaveType").value = "${leave.leaveType.leaveTypeId}";
</script>
</body>
</html>
...
<link href="css/mainIframe.css" rel="stylesheet" type="text/css" />	
			...
			{
				var approver = document.getElementById("leave.approver").value;
...
<body>
 <form action="leave_send" method="post" name="frm" onsubmit="return sendApprover();">
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：考勤管理-报送请假申请</td>
              </tr>
            </table></td>
              ...
              <tr>
                ...
                <td width="60"><table width="90%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <a href="leave_approverList"><img src="images/goback.gif" width="14" height="14" border="0" /></a></div></td>
        ...
        <td>
        	<div style="height:440px;background-color:">
        		<div class="addDiv">
        				...
        				<input type="hidden" name="leave.state" value="已提交" />
        		...
        		<input class="btnClick" name="add" type="submit" value="确认报送"/>
          		<input class="btnClick" name="cancel" type="button" value="取消" onclick="self.location='leave_approverList';" />
        	</div>
        </td>

...
<body>
 <form action="leave_approverList" method="post" name="frm">
 ...
 <s:iterator  value="leaves" >  
          <tr>
            ...
            <span class="STYLE4">
             ...
             <a href="leave_approver?leaveId=${leaveId}&currentPage=${page.currentPage}">
            ...
            <img src="images/del.gif" width="16" height="16" border="0"/>删除	
             ...
             <a href="leave_approver?leaveId=${leaveId}&currentPage=${page.currentPage}">
            	<img src="images/edt.gif" width="16" height="16" border="0"/>审批</a>&nbsp; &nbsp;
            <font color="#999999" >
            <a href="leave_send?leaveId=${leaveId}&currentPage=${page.currentPage}">
            <img src="images/send.gif" width="16" height="16" border="0"/>报送上级</a>&nbsp; &nbsp;
            <a onclick="return confirm('确定要处理审批吗？\n不能更改');" href="leave_approverEnd?leaveId=${leaveId}&currentPage=${page.currentPage}">
          ...
          <tr>
            ...
            <td><table border="0" align="right" cellpadding="0" cellspacing="0">
                ...
                <s:if test="page.hasFirst">
                  <td width="40">
                  	<a href="leave_approverList?currentPage=1"><img src="images/first.gif" border=0></a>&nbsp;
                  </td>
                </s:if>
                <s:else>
                  <td width="40">
               ...
               <s:if test="page.hasPrevious">
                  <td width="40">
                  	<a href="leave_approverList?currentPage=${page.currentPage-1}"><img src="images/back.gif" border=0></a>&nbsp;
                  </td>
                </s:if>
                <s:else>
                  <td width="40">
               ...
               <s:if test="page.hasNext">
                  <td width="40">
                  	<a href="leave_approverList?currentPage=${page.currentPage+1}"><img src="images/next.gif" border=0></a>&nbsp;
                  </td>
                </s:if>
                <s:else>
                  <td width="40">
              ...
              <s:if test="page.hasLast">
                  <td width="40">
                  	<a href="leave_approverList?currentPage=${page.totalPage}"><img src="images/last.gif" border=0></a>&nbsp;
                  </td>
                </s:if>
                <s:else>
                  <td width="40">

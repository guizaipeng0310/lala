...
<body>
 <form action="leave_submit" method="post" name="frm" onsubmit="return sendApprover();">
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：考勤管理-提交请假申请</td>
              </tr>
            </table></td>
              ...
              <tr>
                ...
                <td width="60"><table width="90%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <a href="leave_my"><img src="images/goback.gif" width="14" height="14" border="0" /></a></div></td>
        ...
        <td>
        	<div style="height:440px;background-color:">
        		<div class="addDiv">
        				...
        				<input type="hidden" name="leave.state" value="待审批" />
        			...
        			<table class="addTable" >
        			    ...
        			    <td>
        			    <select name="leave.approver" style="width:300px">
